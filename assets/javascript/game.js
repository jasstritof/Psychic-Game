...
// Array of Letter Options (all lowercase).
var lettersList = ["a", "b", "c", "d", "e", "f",
  "g", "h", "i", "j", "k", "l", "m", "n", "o","p","q", "r", "s", "t", "u", "v", "w", "x", "y", "z"];

// Computer selected letter will be held here.
var chosenLetter = "";
...
function roundComplete() {
  ...
  if (chosenLetter.toString() === blanksAndSuccesses.toString()) {

    // Add to the win counter
    winCounter++;

    // Give the user an alert
    alert("You win! The correct letter was "+ chosenLetter.toUpperCase() +".");
